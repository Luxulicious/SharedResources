...
namespace TheLuxGames.SharedResources.Input
{
    ...
    public class MouseInput : MonoBehaviour
    {
        ...
        [Header("Controls")] [SerializeField] private KeyCode _primary = KeyCode.Mouse0;
        [SerializeField] private KeyCode _secondary = KeyCode.Mouse1;
        [SerializeField] private KeyCode _tertiary = KeyCode.Mouse2;
        ...
        [Space] [Header("Mouse Button Events")] [SerializeField]
        ...
        [SerializeField] private MouseButtonTertiaryEvent _mouseButtonTertiaryEvent = new MouseButtonTertiaryEvent();

        [Space] [Header("Mouse Button Up Events")] [SerializeField]
        ...
        [Space] [Header("Mouse Button Down Events")] [SerializeField]
        ...
        void Start()
        {
            if (_primary != KeyCode.Mouse0 && _primary != KeyCode.Mouse1 && _primary != KeyCode.Mouse2 &&
                _primary != KeyCode.Mouse3 && _primary != KeyCode.Mouse4 && _primary != KeyCode.Mouse5 &&
                _primary != KeyCode.Mouse6)
                _primary = KeyCode.Mouse0;
            if (_secondary != KeyCode.Mouse1 && _secondary != KeyCode.Mouse1 && _secondary != KeyCode.Mouse2 &&
                _secondary != KeyCode.Mouse3 && _secondary != KeyCode.Mouse4 && _secondary != KeyCode.Mouse5 &&
                _secondary != KeyCode.Mouse6)
                _secondary = KeyCode.Mouse1;
            if (_tertiary != KeyCode.Mouse2 && _tertiary != KeyCode.Mouse1 && _tertiary != KeyCode.Mouse2 &&
                _tertiary != KeyCode.Mouse3 && _tertiary != KeyCode.Mouse4 && _tertiary != KeyCode.Mouse5 &&
                _tertiary != KeyCode.Mouse6)
        ...
        {
            if (UnityEngine.Input.GetKey(_primary))
            {
                if (_mouseButtonPrimaryTime <= 0)
                    _mouseButtonPrimaryDownEvent.Invoke();
                _mouseButtonPrimaryTime += UnityEngine.Time.deltaTime;
        ...
        {
            if (UnityEngine.Input.GetKey(_secondary))
            {
                if (_mouseButtonSecondaryTime <= 0)
                    _mouseButtonSecondaryDownEvent.Invoke();
                _mouseButtonSecondaryTime += UnityEngine.Time.deltaTime;
        ...
        {
            if (UnityEngine.Input.GetKey(_tertiary))
            {
                if (_mouseButtonTertiaryTime <= 0)
                    _mouseButtonTertiaryDownEvent.Invoke();
                _mouseButtonTertiaryTime += UnityEngine.Time.deltaTime;
