...
using TheLuxGames.SharedResources.Extensions;
using UnityEngine;
using UnityEngine.Events;


[Obsolete("Use TheLuxGames.SharedResource.Time.Timer instead")]
[Serializable]
...
public class FloatSmallerThanEventEmitter
{
    ...
    [SerializeField] private FloatSmallerThanEvent _floatSmallerThanEvent = new FloatSmallerThanEvent();
...
public class FloatLargerThanEventEmitter
{
    ...
    [SerializeField] private FloatLargerThanEvent _floatLargerThanEvent = new FloatLargerThanEvent();
...
public class FloatBetweenValuesEventEmitter
{
    ...
    [SerializeField] private FloatBetweenValuesEvent _floatBetweenValuesEvent = new FloatBetweenValuesEvent();
...
public class CountDownTimer : MonoBehaviour
{
    ...
    [SerializeField] private float _floatComparisonThreshold = 1e-37f;

    [Space, Header("Events")] [SerializeField]
    private TimerUpdateEvent _timerUpdateEvent = new TimerUpdateEvent();

    [SerializeField] public TimerEndedEvent timerEndedEvent = new TimerEndedEvent();
